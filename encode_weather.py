...
if __name__ == '__main__':
	...
	print("MAE Training Set:", torch.mean(torch.abs(train_reconstructed_x - train_x)).item())

	validation_reconstructed_x, validation_hidden_x = dbn.reconstructor(validation_x)
	print("MAE Validation Set:", torch.mean(torch.abs(validation_reconstructed_x - validation_x)).item())