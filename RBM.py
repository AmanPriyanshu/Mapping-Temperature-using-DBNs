...
if __name__ == '__main__':
	...
	rbm = RBM(10, 100, epochs=50, mode='bernoulli', lr=0.001, optimizer='adam', gpu=True, savefile='./raw_files/save_example_rbm.pt', early_stopping_patience=50)
	print("Before Training:", rbm.vb)
	rbm.train(dataset)
	print("After Training:", rbm.vb)
	rbm.load_rbm('./raw_files/save_example_rbm.pt')
